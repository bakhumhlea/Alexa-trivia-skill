...
const GAME_LENGTH = 8;  // The number of questions per trivia game.
const GAME_STATES = {
    TRIVIA: "_TRIVIAMODE", // Asking trivia questions.
    START: "_STARTMODE", // Entry point, start the game.
    HELP: "_HELPMODE", // The user is asking for help.
};
const APP_ID = 'amzn1.ask.skill.658a8cf7-569c-4940-83c5-284fc4a1c0f9'; // TODO replace with your app ID (OPTIONAL)
...
const languageString = {
    "en": {
        "translation": {
            ...
            "GAME_NAME": "Man United Quiz", // Be sure to change this for your skill.
...
const newSessionHandlers = {
    "LaunchRequest": function () {
        this.handler.state = GAME_STATES.START;// QUESTION:
